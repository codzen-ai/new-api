        ...
        {editMode === 'visual' ? (
          ...
          <SettingsForm onSubmit={form.handleSubmit(onSave)}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('Per-group model ratio')}</FormLabel>
                  <FormControl>
                    <JsonCodeEditor
                      value={field.value}
                      onChange={field.onChange}
                  ...
                  <FormDescription>
                    {t('Nested JSON: group →')} {`{ model: ratio }`}{' '}
                    {t(
                      "is that model's group ratio in that group: it replaces the group ratio and any inter-group override, while the model keeps its own pricing (global model ratio, fixed price, or billing expression)."
                    )}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
